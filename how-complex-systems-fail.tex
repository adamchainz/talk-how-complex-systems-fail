...
\frame{
    ...
    \begin{itemize}
        \item Developer/DBA/Sysadmin at YPlan
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        \item Changes modify the different failures possible
        \item You can never fix everything
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        \item Reducing variability introduces ``black swans''
    \end{itemize}
